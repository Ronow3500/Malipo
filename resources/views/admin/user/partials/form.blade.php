                    ...
                    <div class="row">
                        <div class="col">
                         <div class="mb-3">
                           ...
                           value="@isset($create) {{ old('name') }} @endisset @isset($user) {{ $user->name }} @endisset" aria-describedby="name">
                           @error('name')
                        ...
                        <div class="col">
                          ...
                          value="@isset($create) {{ old('email') }} @endisset @isset($user) {{ $user->email }} @endisset" aria-describedby="email">
                          @error('email')
                          <span class="invalid-feedback" role="alert">
                              {{ $message }}
                          </span>
